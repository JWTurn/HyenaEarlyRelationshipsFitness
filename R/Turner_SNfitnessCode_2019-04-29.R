### Models ====
# SN fitness
# Julie Turner, Patrick Bills, Kay Holekamp
...
data.f.long.cd <- na.omit(subset(DT.obs, period == 'cd'), cols = 'longevity_years')
data.f.long.di <- na.omit(subset(DT.obs, period == 'di'), cols = 'longevity_years')
data.f.long.ad <- na.omit(subset(DT.obs, period == 'adult'), cols = 'longevity_years')
data.f.ars.cd <- na.omit(subset(DT.obs, period == 'cd'), cols = 'annual_rs')
data.f.ars.di <- na.omit(subset(DT.obs, period == 'di'), cols = 'annual_rs')
data.f.ars.ad <- na.omit(subset(DT.obs, period == 'adult'), cols = 'annual_rs')
